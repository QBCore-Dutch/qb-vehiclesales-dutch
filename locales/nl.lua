local Translations = {
    error = {
        ...
        no_space_on_lot = 'Er is geen ruimte voor uw auto op de kavel!',
        not_in_veh = 'Je zit niet in een voertuig!',
        not_for_sale = 'Dit voertuig is NIET te koop!',
    },
    menu = {
        view_contract = 'Contract bekijken',
        view_contract_int = '[E] Contract bekijken',
        sell_vehicle = 'Voertuig verkopen',
        sell_vehicle_help = 'Voertuig verkopen aan medeburgers!',
        sell_back = 'Auto terug verkopen!',
        sell_back_help = 'Verkoop uw auto direct terug tegen een lagere prijs!',
        interaction = '[E] Voertuig verkopen',
    },
    success = {
